...
export const metadata: Metadata = {
  title: 'Conditions Générales d\'Utilisation | JobCallCenter',
  description: 'Conditions générales d\'utilisation du site JobCallCenter.ma',
}
      ...
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-sm p-8">
        ...
        <section className="mb-8">
          <div className="mb-6">
            ...
            <p className="text-gray-600">Les présentes CGU régissent les conditions d'utilisation du site JobCallCenter.ma par tout utilisateur.</p>
          </div>
