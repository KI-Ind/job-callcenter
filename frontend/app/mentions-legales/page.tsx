...
export const metadata: Metadata = {
  title: 'Mentions Légales | TonCallCenter.ma',
  description: 'Mentions légales et informations juridiques concernant le site TonCallCenter.ma',
}
    ...
    <div className="container mx-auto px-4 py-12">
      <div className="max-w-4xl mx-auto bg-white rounded-lg shadow-sm p-8">
        ...
        <section className="mb-8">
          ...
          <p className="mb-2">Le site TonCallCenter.ma est édité par :</p>
          <ul className="list-none space-y-2 text-gray-600 ml-1">
            ...
            <li><strong>Email :</strong> <a href="mailto:contact@toncallcenter.ma" className="text-blue-600 hover:underline">contact@toncallcenter.ma</a></li>
        ...
        <section className="mb-8">
          ...
          <p className="text-gray-600">Email de contact : <a href="mailto:dpo@toncallcenter.ma" className="text-blue-600 hover:underline">dpo@toncallcenter.ma</a></p>
        </section>
      </div>
    </div>
  )
